const components = [
	...
	table { width: 100%; border: 0px; border-collapse: separate; }
	
	/* Heading */
	h1       {font-size: 42px; line-height: 48px; font-weight: 700;}
	h2       {font-size: 36px; line-height: 41px; font-weight: 700;}
	h3       {font-size: 30px; line-height: 34px; font-weight: 700;}
	h4       {font-size: 24px; line-height: 28px; font-weight: 700;}
	
	/* Paragraph */
	.p1-bold {font-size: 18px; line-height: 21px; font-weight: 700;}
	.p1      {font-size: 18px; line-height: 21px; font-weight: 400;}
	.p2-bold {font-size: 14px; line-height: 16px; font-weight: 700;}
	.p2      {font-size: 14px; line-height: 16px; font-weight: 400;}
	...
	/* Caption */
	.c-bold  {font-size: 12px; line-height: 14px; font-weight: 700;}
	.c       {font-size: 12px; line-height: 14px; font-weight: 400;}
	...
	.bg-blue {
			background-color: rgba(146, 181, 253, .16);
			/* background-color: #E5F5FF; */
	}
	.bg-yellow { background-color: #FFDB4D;}
	.bg-red    { background-color: #FC3F1D;}
	...
	summary.pseudo { display: none; }
	summary { list-style: none; }
	details summary::marker, /* Latest Chrome, Edge, Firefox */ 
	details summary::-webkit-details-marker /* Safari */ { display: none; }
	.summary-custom { margin: 0px; max-height: 80px; }
	.details-content { margin-top: 12px;}
	hr { margin: 12px 0;}
	.wiki-cut__summary { color: inherit; }
	.hr {height: 1px; background-color: #DBE2E7;}
	
	/* Buttons */
	.btn50  {height: 50px; line-height: 50px;}
	
	/* Addiction width */
	.container-mobile { max-width: 390px;  margin: 0 auto; }
	.container        { max-width: 1216px; margin: 0 auto; }
	
	.border-gray { border: 1px solid rgba(128,128,128,.16); }
	...
	.l125   { width: 210px !important; height: 50px !important; }
	.l1     { width: 168px !important; height: 40px !important; }
	.l075   { width: 126px !important; height: 30px !important; }
	.l05    { width: 84px  !important; height: 20px !important; }`,
	},
	{
		title: 'columns',
		items: [
